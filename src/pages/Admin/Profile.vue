<template>
  <q-page class="q-pa-lg">
    <h3 class="text-bold q-my-none q-mb-lg">Профиль</h3>

    <div class="q-pa-xl bg-white shadow-block rounded-sm q-mx-auto" style="max-width: 700px">
      ...
      <div class="q-mb-md">
        <q-input v-model="userData.name" outlined class="full-width" color="brand" label="Имя" />
      </div>
      ...
      <div class="q-mb-md">
        <q-input v-model="userData.surName" outlined class="full-width" color="brand" label="Отчество" />
      </div>
